...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/tommynurwantoro/go-fiber-template#manual-installation) section in README.md)
